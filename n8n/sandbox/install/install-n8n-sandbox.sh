...
echo ""
echo -e "  Wie deine n8n-Instanz(en) diese Sandbox konkret nutzen (z.B. für den"
echo -e "  Code-Node), hängt von deiner n8n-Version ab – Details dazu in den"
echo -e "  n8n-Release-Notes bzw. unter ${CYAN}${SANDBOX_GUIDE}${RESET}."
echo ""
